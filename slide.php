...
<!--            <li><a href="<?php bloginfo('home')?> ">Aniversariantes</a></li>-->
       ...
       <div class="niver" id="mais">
            ...
            <div class="title-pg" >
             ...
             <?php query_posts('category_name=aniversariantes&offset=0&showposts=50');?>
             <?php if (have_posts()): while(have_posts()) : the_post(); ?>
            
            <div class="niver-content">
             <div class="col-md-3">
                
                <div class="bloco-aniversario backniver">
                <div class="col-md-3">
                    <div class="aniversario-usurario-bloco">
                    <img class="img-niver" src="<?php bloginfo ('template_url') ?>/img/2.jpg">
                    </div>
                </div>  
                <div class="col-md-9">
                    <div class="informacoes-niver">
                       <?php the_content(); ?> 
